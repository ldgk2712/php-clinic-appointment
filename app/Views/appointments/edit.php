<div class="page-header">
    <div>
        <h1>Edit Appointment #<?= e($data['id']) ?></h1>
        <p>Submit by POST /appointments/update. On success, redirect to /appointments.</p>
    </div>
</div>
...
<form class="form-card" method="post" action="/appointments/update">
    ...
    <div class="form-row">
        ...
        <input type="text" name="appointment_code" maxlength="50" required value="<?= e(old($data, 'appointment_code')) ?>">
