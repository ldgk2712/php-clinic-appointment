<div class="page-header">
    <div>
        ...
        <p>Submit by POST /patients/store. On success, redirect to /patients.</p>
    </div>
</div>
...
<div class="form-grid">
    ...
    <aside class="side-card">
        ...
        <ul>
            ...
            <li>Phone pattern is validated.</li>
            <li>Duplicate email shows friendly error.</li>
            <li>Old input is kept when validation fails.</li>
        </ul>
    </aside>
</div>
