...
class PatientRepository
{
    ...
    {
        $allowedSorts = ['id', 'name', 'email', 'phone', 'gender', 'status', 'created_at'];
        ...
        $sql = "SELECT id, name, email, phone, gender, status, created_at FROM patients";
        $params = [];
    ...
    {
        $sql = "INSERT INTO patients (name, email, phone, gender, status, note)
                VALUES (:name, :email, :phone, :gender, :status, :note)";
