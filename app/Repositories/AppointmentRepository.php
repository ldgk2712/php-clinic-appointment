...
class AppointmentRepository
{
    ...
    public function getPaginated(string $keyword, int $limit, int $offset, string $sort, string $direction): array
    {
        ...
        $sql = "SELECT id, appointment_code, patient_name, patient_email, appointment_date, department, status, created_at
                FROM appointments";
        $params = [];
    ...
    {
        $sql = "INSERT INTO appointments (appointment_code, patient_name, patient_email, appointment_date, department, status, note)
                VALUES (:appointment_code, :patient_name, :patient_email, :appointment_date, :department, :status, :note)";
